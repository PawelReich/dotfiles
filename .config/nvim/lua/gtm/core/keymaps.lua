...
local function git_helper(action)
  local script_path = vim.fn.expand("~/.local/git_helper.fish")
...
vim.keymap.set("n", "<leader>gy", function() git_helper("copy-url") end, { desc = "" })
vim.keymap.set("n", "<leader>go", function() git_helper("goto-issue") end, { desc = "Helix Script: Goto Issue" })
